...
public class BaseController {
    ...
    @Before
    public void before(Contact contact) {
        System.out.println(contact.getId() + "消息 运行之前");
    ...
    @After
    public void after(Contact contact, @ReturnResult Object t1) {
        System.out.println("处理结果 =>" + t1);
        System.out.println(contact.getId() + " 消息 运行之后");
